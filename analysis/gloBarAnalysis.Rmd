...
gg_acc_arag_loc2_lm <- ggplot(
  ...
  # label points by loc2 (CAPS, larger)
  geom_text(
  ...
  # LM labels (equation, R², p) only for significant basins
  geom_text(
  ...
  theme(
    # remove gridlines just in case
    panel.grid = element_blank(),

    # bigger axis titles and tick labels
    axis.title = element_text(size = 22),
    axis.text  = element_text(size = 18),

    # black box around plotting region
    panel.border = element_rect(color = "black", fill = NA, linewidth = 1),

    # let the box be the frame (no extra axis lines)
    axis.line = element_blank(),

    legend.position = "none",

    # enforce square panel shape
    aspect.ratio = 1
  )
