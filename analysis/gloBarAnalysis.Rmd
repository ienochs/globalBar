...
# Constants & Paths
rootFolder <- getwd()
data_dir   <- file.path(rootFolder, "Github", "globalBar", "analysis", "data")
atl_path   <- file.path(data_dir, "NCRMP_Atlantic_allBmuData.xlsx")
pac_path   <- file.path(data_dir, "NCRMP_Pacific_allBmuData.xlsx")

p_dir <- file.path(rootFolder, "Github", "globalBar", "analysis", "data", "parrotfish")
...
e_dir <- file.path(rootFolder, "Github", "globalBar", "analysis", "data", "environmental")
...
to_loc3 <- function(region, loc2, subRegion, siteName, basin, dataset_type, lat = NA_real_) {
  ...
  pac_dir_map <- c(
    ...
    # Oahu
    "OCC-OAH-002"="north","OCC-OAH-005"="east","OCC-OAH-007"="east","OCC-OAH-008"="southeast", "OCC-OAH-009"="south","OCC-OAH-010"="south","OCC-OAH-014"="southwest","OCC-OAH-012"="west",
    # FFS
...
# Read & Bind Bar Data
barData_raw <-
  read_bind_excel(c(atl_path, pac_path)) %>%
  drop_all_na_rows()
...
```{r, echo=FALSE}
tif_path <- "C:/Users/ienoc/Documents/GitHub/globalBar/analysis/data/population/gpw-v4-population-count-adjusted-to-2015-unwpp-country-totals-rev11_2005_30_sec_tif/gpw_v4_population_count_adjusted_to_2015_unwpp_country_totals_rev11_2005_30_sec.tif"
...
responses <- c(
  deltaMass_mgcm2y       = "Δ mass (mg cm^-2 y^-1)",
  deltaVolume_mm3cm2y    = "Δ volume (mm^3 cm^-2 y^-1)",
  deltaDensity_mgcm3cm2y = "Δ density (mg cm^-3 cm^-2 y^-1)",
  macroboring_mm3cm2y    = "Macroboring (mm^3 cm^-2 y^-1)",
  grazing_mm3cm2y        = "Grazing (mm^3 cm^-2 y^-1)"
)
