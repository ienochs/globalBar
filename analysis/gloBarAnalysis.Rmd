...
environmentalData <- read.csv(paste(rootFolder,"/Github/globalBar/analysis/data/environmental/eds_time.csv",sep=""), header=TRUE, sep=",") #import data
environmentalData<-environmentalData%>%
  ...
  mutate(loc3 =(case_when(
    ...
    lat == 13.47516 ~ "OCC-GUA-005",
    lat == 13.4752 ~ "OCC-GUA-005", #does this exist?
    lat == 13.24126 ~ "OCC-GUA-009",
    lat == 13.2421 ~ "OCC-GUA-009",
    lat == 13.52894 ~ "OCC-GUA-015",
    lat == 13.52896 ~ "OCC-GUA-015",
    lat == 20.03567 ~ "OCC-MAU-002",
    lat == 20.0357 ~ "OCC-MAU-002",
    lat == 20.02033 ~ "OCC-MAU-005",
    lat == 20.02039 ~ "OCC-MAU-005",
    lat == 20.01312 ~ "OCC-MAU-008",
    lat == 20.01315 ~ "OCC-MAU-008",
    lat == 20.02296 ~ "OCC-MAU-016",
    lat == 20.02249 ~ "OCC-MAU-018",
    lat == 20.01398 ~ "OCC-MAU-019",
    lat == 18.16784 ~ "OCC-PAG-002",
    lat == 18.16788 ~ "OCC-PAG-002",
    lat == 18.09609 ~ "OCC-PAG-006",
    lat == 18.09612 ~ "OCC-PAG-006",
    lat == 18.04561 ~ "OCC-PAG-009",
    lat == 18.04564 ~ "OCC-PAG-009",
    lat == 18.12009 ~ "OCC-PAG-013",
    lat == 18.12014 ~ "OCC-PAG-013",
    lat == 15.29062 ~ "OCC-SAI-002",
    lat == 15.25866 ~ "OCC-SAI-005",
    lat == 15.25867 ~ "OCC-SAI-005",
    lat == 15.09785 ~ "OCC-SAI-009",
    lat == 15.09788 ~ "OCC-SAI-009",
    lat == 15.15639 ~ "OCC-SAI-012",
    lat == 15.15645 ~ "OCC-SAI-012",
    lat == 15.25719 ~ "OCC-SAI-016",
    lat == 20.26824 ~ "OCC-HAW-002",
    lat == 19.24436 ~ "OCC-HAW-010",
    lat == 20.24916 ~ "OCC-HAW-014",
    lat == 21.59095 ~ "OCC-OAH-002",
    lat == 21.47971 ~ "OCC-OAH-005",
    lat == 21.45862 ~ "OCC-OAH-007",
    lat == 21.28838 ~ "OCC-OAH-010",
    lat == 21.53412 ~ "OCC-OAH-012",
    lat == 21.59095 ~ "OCC-OAH-012",
    lat == 23.79247 ~ "OCC-FFS-014", #Note use this for all the FFS sites
    lat == 27.94055 ~ "OCC-PHR-002",
    lat == 27.78237 ~ "OCC-PHR-012",
    lat == 27.79316 ~ "OCC-PHR-016",
    lat == -0.36896 ~ "OCC-JAR-003",
    lat == -0.36776 ~ "OCC-JAR-003",
    lat == -0.38234 ~ "OCC-JAR-008",
    lat == -0.36896 ~ "OCC-JAR-013",
    lat == 5.89733 ~ "OCC-PAL-003",
    lat == 5.86379 ~ "OCC-PAL-008",
    lat == 5.88322 ~ "OCC-PAL-017",
    lat == 19.31602 ~ "OCC-WAK-002",
    lat == 19.30616 ~ "OCC-WAK-005",
    lat == 19.28065 ~ "OCC-WAK-008",
    lat == 19.31625 ~ "OCC-WAK-013",
    lat == -14.15785 ~ "OCC-OFU-002",
    lat == -14.1733 ~ "OCC-OFU-009",
    lat == -14.2124 ~ "OCC-TAU-002",
    lat == -14.25755 ~ "OCC-TAU-011",
    lat == -14.24479 ~ "OCC-TUT-002",
    lat == -14.28521 ~ "OCC-TUT-007",
    lat == -14.36351 ~ "OCC-TUT-017",
    lat == -14.29464 ~ "OCC-TUT-022"))) 
```
