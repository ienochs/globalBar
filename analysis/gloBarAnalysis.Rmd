...
# =========================
long_df <- barData1 %>% ###JTM Note: Should we be using the barData file with NA's removed rather than the entire barData file again???
...
##tif_path <- file.path(rootFolder, "Github", "globalBar", "analysis", "data", "population", "gpw_v4_population_count_adjusted_to_2015_unwpp_country_totals_rev11_2020_30_sec.tif") #Original code
tif_path <- file.path(rootFolder, "data", "population", "gpw_v4_population_count_adjusted_to_2015_unwpp_country_totals_rev11_2020_30_sec.tif")
...
# 5) Build a long data frame JUST for totalGravity analysis, using barData
...
# 6) Make the gravity vs response plot (5 metrics × 3 basin groups)
