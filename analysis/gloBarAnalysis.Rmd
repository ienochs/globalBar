...
Boxplots of deltaMass_mgcm2y by region and subregion
```{r, echo=FALSE}
...
plot_deltaMassRegion_Atlantic <- ggarrange(boxplotMassRegionSubregion_DRTO, boxplotMassRegionSubregion_FGB, boxplotMassRegionSubregion_FLK, boxplotMassRegionSubregion_PR, boxplotMassRegionSubregion_STJ, boxplotMassRegionSubregion_STT, boxplotMassRegionSubregion_STX, ncol = 4, nrow = 2, align = "h")
